...
from (
        select product_id, "2020" report_year, (datediff(if(period_end < "2021-01-01", period_end, date("2020-12-31")), 
        ...
        select product_id, "2019" report_year, (datediff(if(period_end < "2020-01-01", period_end, date("2019-12-31")),
        ...
        select product_id, "2018" report_year, (datediff(if(period_end<"2019-01-01",period_end,date("2018-12-31")),
...
join sales s on p.product_id = s.product_id and year(bound) between year(period_start) and year(period_end)
