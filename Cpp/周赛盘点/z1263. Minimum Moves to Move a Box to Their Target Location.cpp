            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (cur.box == man_next) {
                    ...
                    if (grid[b_nx][b_ny] != '#' && getDist(box_next, man_next) == -1) {
                        q.emplace_back(box_next, man_next);
                    ...
                    q.emplace_front(cur.box, man_next);
                    getDist(cur.box, man_next) = getDist(cur.box, cur.man);
                }
            }
        }
        return -1;
