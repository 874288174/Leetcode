...
public:
    int minCost(vector<vector<int>>& grid) {
        ...
        // for the pair, the first element is the cell position, the second is the path cost to this cell
        ...
        while(!q.empty())
        {
            ...
            if (visited.insert(t.first).second)  
                // If we have never visited this node, then we have the shortest path to this node
                res = t.second;
